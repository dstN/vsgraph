		...
		<div style={{ width: '100%', height }}>
			<ResponsiveContainer>
				<RLineChart data={data} margin={{ top: 8, right: 16, bottom: 8, left: 8 }}>
					{showGrid && <CartesianGrid stroke="currentColor" strokeDasharray="4 4" strokeOpacity={0.6} />}

					<XAxis dataKey={idx} stroke="currentColor" tick={{ fill: 'currentColor' }} axisLine={{ stroke: 'currentColor' }} tickLine={{ stroke: 'currentColor' }} />
					<YAxis domain={domain} tickFormatter={(v) => valueFormatter(v)} width={56} stroke="currentColor" tick={{ fill: 'currentColor' }} axisLine={{ stroke: 'currentColor' }} tickLine={{ stroke: 'currentColor' }} />
