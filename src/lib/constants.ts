...
export const DELIKT_LABEL_OVERRIDES: Record<string, string> = {
  ...
  vorbereitung_einer_staatsgefaehrdenden_gewalttat: "Vorbereitung staatsgef. Gewalttat",
  mitgliedschaft_bzw_unterstuetzung_einer_auslaendischen_terroristischen_vereinigung: "Unterstützung ausl. terr. Vereinigung",
  verstoesse_gegen_das_versammlungsgesetz: "Verstöße Versammlungsgesetz",
  verstoesse_gegen_das_vereinsgesetz: "Verstöße Vereinsgesetz",
