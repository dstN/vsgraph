...
export const getYAxisDomain = (autoMinValue: boolean, minValue?: number, maxValue?: number): readonly [number | 'auto', number | 'auto'] => {
...
// Semantik: Liefert true, wenn der Key höchstens EINMAL im Array vorkommt.
export function hasOnlyOneValueForKey<T extends Record<string, unknown>, K extends keyof T>(array: T[], keyToCheck: K): boolean {
	let count = 0;
